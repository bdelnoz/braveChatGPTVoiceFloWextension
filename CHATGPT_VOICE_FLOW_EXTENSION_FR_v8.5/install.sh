...
printf '  4. Clique sur "Load unpacked" ou "Charger l extension non empaquetée".\n'
...
printf '  Ce script ne peut pas charger automatiquement une extension dans Brave.\n'
printf '  Brave impose le chargement manuel via brave://extensions/.\n'
printf '\n'

if command -v xdg-open >/dev/null 2>&1; then
  printf 'Ouverture possible de brave://extensions/ avec xdg-open.\n'
  printf 'Si tu veux ouvrir maintenant, lance :\n'
  printf '  xdg-open brave://extensions/\n'
fi
